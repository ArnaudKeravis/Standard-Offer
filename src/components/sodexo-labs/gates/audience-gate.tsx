...
import type { LabsAudience } from "@/lib/sodexo-labs/schemas";
...
export function AudienceGate({ onSelect }: AudienceGateProps) {
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl">
        ...
        <p className="mb-12 max-w-xl text-lg text-[var(--labs-muted)]">
          Choose the audience for this session. You can change it later from
          the deck.
        </p>
