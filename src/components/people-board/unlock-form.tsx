...
import { unlockPeopleAction } from "@/app/people/unlock/actions";

export function PeopleUnlockForm({ next }: { next: string }) {
    ...
    <form
      ...
      action={(formData) => {
        ...
        startTransition(async () => {
          const result = await unlockPeopleAction(formData);
